package ru.mgt.icp.notificationmanagment.contract.proto;
...
public final class SendServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest,
      ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = ru.mgt.icp.notificationmanagment.contract.proto.SendRequest.class,
      responseType = ru.mgt.icp.notificationmanagment.contract.proto.SendResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest,
      ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendMethod() {
    io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest, ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendMethod;
      ...
      synchronized (SendServiceGrpc.class) {
        if ((getSendMethod = SendServiceGrpc.getSendMethod) == null) {
          SendServiceGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest, ru.mgt.icp.notificationmanagment.contract.proto.SendResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.mgt.icp.notificationmanagment.contract.proto.SendRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.mgt.icp.notificationmanagment.contract.proto.SendResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest,
      ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendTestMethod;
  ...
  public static io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest,
      ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendTestMethod() {
    io.grpc.MethodDescriptor<ru.mgt.icp.notificationmanagment.contract.proto.SendRequest, ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> getSendTestMethod;
  ...
  public static abstract class SendServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request,
        io.grpc.stub.StreamObserver<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendMethod(), responseObserver);
    }

    /**
     */
    public void sendTest(ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request,
        io.grpc.stub.StreamObserver<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ru.mgt.icp.notificationmanagment.contract.proto.SendRequest,
                ru.mgt.icp.notificationmanagment.contract.proto.SendResponse>(
                  this, METHODID_SEND)))
          .addMethod(
            getSendTestMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
  ...
  public static final class SendServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SendServiceBlockingStub> {
    ...
    /**
     */
    public ru.mgt.icp.notificationmanagment.contract.proto.SendResponse send(ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request) {
    ...
    /**
     */
    public ru.mgt.icp.notificationmanagment.contract.proto.SendResponse sendTest(ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SendServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SendServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> send(
        ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse> sendTest(
        ru.mgt.icp.notificationmanagment.contract.proto.SendRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((ru.mgt.icp.notificationmanagment.contract.proto.SendRequest) request,
              (io.grpc.stub.StreamObserver<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse>) responseObserver);
          break;
        case METHODID_SEND_TEST:
          serviceImpl.sendTest((ru.mgt.icp.notificationmanagment.contract.proto.SendRequest) request,
              (io.grpc.stub.StreamObserver<ru.mgt.icp.notificationmanagment.contract.proto.SendResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SendServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.mgt.icp.notificationmanagment.contract.proto.StatusServiceProto.getDescriptor();
    }
